...
public static ArrayList<String> classPassers(ArrayList<String> students,ArrayList<Integer> midtermGrades,ArrayList<Integer> finalGrades,double midtermPercentage,double finalPercentage,double treshold){
    ...
    public static void main(String[] args) {
      ...
      logger.error("hello world");
        ...
        post("/compute", (req, res) -> {
          ...
          ArrayList<String> result = App.classPassers(inputListStudents, inputListMidGrades,inputListFinalGrades,input4AsDouble,input5AsDouble,input6AsDouble);
            ...
            if(result.size() != 0 && result != null){
              ...
              map.put("result","uncomputable! form1:String, form2&3:Integer, form4&5&6:Double. All form's set size must be equal!");
            }
            return new ModelAndView(map, "compute.mustache");
            }, new MustacheTemplateEngine());
